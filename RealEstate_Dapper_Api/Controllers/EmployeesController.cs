...
namespace RealEstate_Dapper_Api.Controllers
{
	...
	public class EmployeesController : ControllerBase
	{
		...
		{
			var values = await _employeeRepository.GetAlEmployeeAsync();
			return Ok(values);
		}
		[HttpPost]
		...
		[HttpPut]
		public async Task<IActionResult> UpadeteEmployee(UpdateEmployeeDto updateEmployeeDto)
		{
			_employeeRepository.UpdateEmployee(updateEmployeeDto);
			return Ok("Personel Güncelledni");
		}
		[HttpGet("{id}")]
