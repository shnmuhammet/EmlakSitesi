...
namespace RealEstate_Dapper_Api.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public async Task<IActionResult> ProductDealOfTheDayStatushangeToTrue(int id)
        {
        ...
        public async Task<IActionResult> ProductDealOfTheDayStatushangeToFalse(int id)
        {
